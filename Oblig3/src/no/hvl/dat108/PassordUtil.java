...
public class PassordUtil {
	...
	/*
	 * Man kunne godt gjort denne klassen mer fleksibel ved å bytte ut konstanter
	 * med konstruktørparametre. På den annen side: MAN MÅ BRUKE SAMME OPPSETT
	...
	/**
	*  Denne metoden genererer en passordstreng for sikker lagring av 
	passord.
	*  Passordstrengen inneholder både saltet som ble brukt i hashingen 
	og
	*  resultatet (digest-et) av hashingen.
	*
	*  Det er ikke noen spesiell grunn til at salt og digest bør slås 
	sammen
	*  til én streng. De kunne godt vært returnert som to verdier (som et 
	par).
	*  Det er gjort slik fordi det gjorde API-et enkelt å bruke, en verdi 
	inn,
	*  en verdi ut.
	*
	...
	*/
	public static String krypterPassord(String passord) throws 
	...
	private static String krypterMedSalt(byte[] salt, String passord) {
		...
		try {
			 ...
			 * plutselig oppstå under kjøring, og det er derfor kanskje ikke nødvendig å
			 * håndtere dem her. Eller...?
			 *
			 * Hvis det skjer en feil, f.eks. at SHA-2 ikke er implementert i aktuell JVM,
			 * vil resultatet av å sluke unntaket bli at vi returnerer en tom streng. Ved
